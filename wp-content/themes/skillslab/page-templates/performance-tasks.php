	...
	<div class="content revealme">
		<div class="centered">
				<?php the_content(); ?>
			 	...
			 	<?php $posts = get_field('performance_task_overview_video'); 
				if ( $posts != '' ) :
					if( $posts ): ?>
...
<section id="pt-list" class="section" role="main">
	<div class="content clear">
		<div class="left revealme">
				 	...
				 	<div class="post">
				 		...
				 		<div class="show-hide">
				 			...
				 			<div class="bottom clear">
				 				<a class="standalone-link" href="<?php echo $link; ?>#performance-tasks">view project page <i class="fa fa-chevron-right"></i></a>
				 				<?php 
					            if($download){ ?>
			...
			<div class="cat-container">
				<h2><span>3</span>Student Driven Campaigns</h2>
